  ...
  return (
    <div className="bg-black opacity-90 shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      {relatedPosts.map((post, index) => (
        <div key={post.title} className=" transition duration-500 transform hover:translate-x-2 flex items-center w-full mb-4 text-white">
          <div className="w-16 flex-none text-white">
            <Image
